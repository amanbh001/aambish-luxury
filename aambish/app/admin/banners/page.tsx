...
const SAMPLE_POSTS: BlogPost[] = [
  {
    ...
    excerpt: "Minimalism in jewellery is not about wearing less — it's about wearing intentionally. Here's how to curate a minimal stack that speaks volumes.",
  ...
  },
  {
    ...
    excerpt: "Your jewellery is an investment. With the right care, it can last a lifetime. Here's everything you need to know to keep your pieces gleaming.",
