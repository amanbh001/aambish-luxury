...
export default function AdminBannersPage() {
  ...
  const toggleActive = async (b: Banner) => {
    await fetch(`/api/admin/banners/${b._id}`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
    ...
    <div style={{ minHeight: '100vh', background: '#F4F3EE', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      >
        <div style={{ display: 'flex', gap: '14px', alignItems: 'center' }}>
          ...
          <span style={{ color: 'rgba(255,255,255,0.65)', fontSize: '12px', letterSpacing: '0.1em' }}>
            Banners
          </span>
        </div>
        <button
      ...
      <div style={{ padding: '28px' }}>
        ...
        >
          <span style={{ fontSize: '18px', color: '#C9A96E', flexShrink: 0, marginTop: '1px' }}>
            ✦
          </span>
          <span>
            Banners are displayed across your homepage and collection pages. <strong>Hero</strong>{' '}
            banners replace the main slider. <strong>Offer</strong> banners appear mid-page.{' '}
            <strong>Category</strong> banners appear in the shop. Upload images at 1920×600px for
            best results.
          </span>
        </div>
        ...
        {loading ? (
          ...
          >
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="skeleton"
                style={{ height: '220px', borderRadius: '4px' }}
              />
            ))}
          </div>
        ) : banners.length === 0 ? (
          ...
          >
            <p style={{ color: '#8A8A7A', marginBottom: '20px' }}>
              No banners yet. Add your first banner to go live.
            </p>
            <button
              onClick={openNew}
              style={{
            ...
            {banners.map((b) => (
              ...
              >
                ...
                <div style={{ position: 'relative', height: '140px', background: '#F4F3EE' }}>
                  ...
                  <span
                    style={{
                      ...
                      fontSize: '10px',
                      fontWeight: 700,
                      background: `${positionColors[b.position]}22`,
                      color: positionColors[b.position],
                      border: `1px solid ${positionColors[b.position]}44`,
                  ...
                  <span
                    style={{
                      ...
                      fontSize: '10px',
                      fontWeight: 700,
                      background: b.isActive ? '#d1fae5' : '#f3f4f6',
                      color: b.isActive ? '#065f46' : '#6b7280',
                    }}
                  >
                ...
                <div style={{ padding: '16px 18px' }}>
                  <h4 style={{ fontSize: '14px', fontWeight: 600, color: '#1A1A18', marginBottom: '4px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '10px', marginTop: '14px' }}>
                    <button
                      ...
                      style={{
                        ...
                        fontWeight: 600,
                        cursor: 'pointer',
                        background: b.isActive ? '#fef3c7' : '#d1fae5',
                        color: b.isActive ? '#92400e' : '#065f46',
                      }}
                    >
      ...
      {showForm && (
        ...
        >
          ...
          >
            ...
            >
              <h3 style={{ fontFamily: 'Georgia, serif', fontSize: '1.3rem', fontWeight: 300 }}>
                {editId ? 'Edit Banner' : 'Add New Banner'}
              </h3>
              <button
                onClick={() => setShowForm(false)}
                style={{ fontSize: '22px', color: '#8A8A7A', background: 'none', border: 'none', cursor: 'pointer' }}
              >
                ×
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} style={{ padding: '24px 28px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div>
                ...
                <p style={{ fontSize: '11px', color: '#8A8A7A', marginTop: '4px' }}>
                  Or paste a Cloudinary/CDN URL below:
                </p>
                <input
                  value={form.image}
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="URL for mobile version (leave blank to use same image)"
                  style={inputStyle}
                />
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
                <div>
                  ...
                  <input
                    ...
                    required
                    placeholder="The Grace Collection"
                    style={inputStyle}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    placeholder="Minimalist luxury pieces"
                    style={inputStyle}
                  />
                </div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
                <div>
                  ...
                  <input
                    ...
                    placeholder="/shop?collection=grace"
                    style={inputStyle}
                  />
                </div>
                <div>
              ...
              <label style={{ display: 'flex', gap: '10px', alignItems: 'center', fontSize: '14px', cursor: 'pointer' }}>
                <input
                  ...
                  style={{ accentColor: '#C9A96E', width: '15px', height: '15px' }}
                />
              ...
              >
                ...
                <button
                  ...
                  style={{
                    padding: '10px 28px',
                    background: submitting ? '#8A8A7A' : '#2C3528',
                    color: 'white',
                    border: 'none',
                    borderRadius: '2px',
                    fontSize: '12px',
